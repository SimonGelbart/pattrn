...
namespace Pattrn.DependencyInjection.Tests.Contracts;
...
public sealed class PublicApiSnapshotTests
{
    ...
    public async Task PublicApiMatchesShippedSnapshot()
    {
        ...
        var updateSnapshotPath = Environment.GetEnvironmentVariable("PUBLIC_DI_API_SNAPSHOT_PATH");
    ...
    {
        var assembly = typeof(PattrnServiceCollectionExtensions).Assembly;
