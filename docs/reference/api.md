...
`PattrnIndex<TSegment, TValue>` is the concrete immutable compiled-index contract. It keeps hot matching explicit and exposes explanation matching as a separate diagnostics-oriented operation:
